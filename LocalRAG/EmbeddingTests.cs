...
namespace LocalRAG
{
    ...
    public class EmbeddingTests
    {
        ...
        private async Task Test_EmbeddingGeneration_PreservesStopWords(RAGConfiguration config)
        {
            ...
            Assert(embedding.Length == 128 || embedding.Length == 256 || embedding.Length == 384 || embedding.Length == 512 || embedding.Length == 768 || embedding.Length == 1024, $"Embedding should be 768 or 1024 dims. Got: {embedding.Length}");
        }
        ...
        private async Task Test_EmbeddingDimension_Is768(RAGConfiguration config)
        {
            ...
            Assert(embedding.Length == 128 || embedding.Length == 256 || embedding.Length == 384 || embedding.Length == 512 || embedding.Length == 768 || embedding.Length == 1024,
