...
namespace LocalRAG
{
    public class FeedbackDatabaseValues
    {
        ...
        // DCS metadata — serialized DcsKey and hard-linked DCN IDs.
        // Stored as compact pipe/comma-delimited strings (not JSON arrays).
        [JsonProperty("DcsKeyData", NullValueHandling = NullValueHandling.Ignore)]
        public string? DcsKeyData { get; set; }

        [JsonProperty("DcsHardLinkedDcns", NullValueHandling = NullValueHandling.Ignore)]
        public string? DcsHardLinkedDcns { get; set; }
    }
